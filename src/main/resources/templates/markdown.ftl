        ...
        <div class="col-sm-5">
            <form id="markdownform">
                ...
                <div class="form-group">
                    ...
                    <#if title??>
                        <input type="text" class="form-control" id="source_title" value="${title}" required>
                    <#else>
                        <input type="text" class="form-control" id="source_title" required>
                    </#if>
                    </div>
                    <label for="source">markdown:</label>
                    <div class="md-header btn-toolbar">
                        <div class="btn-group">
                            <button class="btn-default btn-sm btn" type="button" title="Bold (Ctrl+B)"
                                    tabindex="1"><span
                                    class="glyphicon glyphicon-bold"></span></button>
                            <button class="btn-default btn-sm btn" type="button" title="Italic (Ctrl+I)"
                                    tabindex="2"><span
                                    class="glyphicon glyphicon-italic"></span></button>
                            <button class="btn-default btn-sm btn" type="button" title="Heading (Ctrl+H)"
                                    tabindex="3"><span
                        ...
                        <#--link button modal-->
                            ...
                            <button class="btn-default btn-sm btn" type="button" title="Image (Ctrl+G)"
                                    tabindex="5"><span
                        ...
                        <div class="btn-group">
                            ...
                            <button class="btn-default btn-sm btn" type="button" title="Code (Ctrl+K)"
                                    tabindex="8"><span
                                    class="glyphicon glyphicon-asterisk"></span></button>
                            <button class="btn-default btn-sm btn" type="button" title="Quote (Ctrl+Q)"
                                    tabindex="9"><span
                                    class="glyphicon glyphicon-comment"></span></button>
                            <button class="btn-default btn-sm btn" type="button" title="More (Ctrl+M)"
                                    tabindex="10"><span
                                    class="glyphicon ">M</span></button>
                        </div>
                    </div>
                <#if source_content??>
                    <textarea class="form-control" rows="20" id="source" required>${source_content}</textarea>
                <#else >
                    <textarea class="form-control" rows="20" id="source" required></textarea>
                </#if>
                </div>
